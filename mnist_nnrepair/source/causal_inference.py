...
class causal_analyzer:
    ...
    def get_perturbed_input(self, x):
        ...
        utils_backdoor.dump_image(np.expand_dims(mask*255, axis=2),
                                  '../results/mask_test.png',
                                  'png')
        utils_backdoor.dump_image(np.expand_dims(pattern,axis=2), '../results/pattern_test.png', 'png')
    ...
    def save_tmp_func(self, step):
        ...
        utils_backdoor.dump_image(np.expand_dims(cur_mask, axis=2),
                                  img_filename,
                                  'png')
